...
using static Assignmentfifth.Entity.EmployeeBasicDetailsEntity;
using System.Net;
using Assignmentfifth.Overall;

namespace Assignmentfifth.Services
{
    public class EmployeeBasicDetailService
    {
        public class EmployeeBasicDetailsService : IEmployeeBasicDetails
        {
            ...
            public async Task<EmployeeBasicDetailsDTO> UpdateEmployee(EmployeeBasicDetailsDTO employeeBasicDetailsDTO)
            {
                ...
                existingEmployee.Intialize(false, Main.EmployeeDocumentType, "Yogita", "Shruti");
